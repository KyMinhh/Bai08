...
namespace DataBinding1 {
    ...
    public partial class QLSV2DataSet : global::System.Data.DataSet {
        ...
        private void InitClass() {
            this.DataSetName = "QLSV2DataSet";
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/QLSV2DataSet.xsd";
        ...
        public partial class StudentDataTable : global::System.Data.TypedTableBase<StudentRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public StudentRow AddStudentRow(string FullName, int Age, string Major) {
...
namespace DataBinding1.QLSV2DataSetTableAdapters {
    ...
    public partial class StudentTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Student] WHERE (([StudentId] = @Original_StudentId) AND ((@IsNull_FullName = 1 AND [FullName] IS NULL) OR ([FullName] = @Original_FullName)) AND ((@IsNull_Age = 1 AND [Age] IS NULL) OR ([Age] = @Original_Age)) AND ((@IsNull_Major = 1 AND [Major] IS NULL) OR ([Major] = @Original_Major)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Student] ([FullName], [Age], [Major]) VALUES (@FullName, @Age," +
                " @Major);\r\nSELECT StudentId, FullName, Age, Major FROM Student WHERE (StudentId " +
                "= SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Student] SET [FullName] = @FullName, [Age] = @Age, [Major] = @Major WHERE (([StudentId] = @Original_StudentId) AND ((@IsNull_FullName = 1 AND [FullName] IS NULL) OR ([FullName] = @Original_FullName)) AND ((@IsNull_Age = 1 AND [Age] IS NULL) OR ([Age] = @Original_Age)) AND ((@IsNull_Major = 1 AND [Major] IS NULL) OR ([Major] = @Original_Major)));
SELECT StudentId, FullName, Age, Major FROM Student WHERE (StudentId = @StudentId)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::DataBinding1.Properties.Settings.Default.QLSV2ConnectionString;
        }
        ...
        public virtual int Fill(QLSV2DataSet.StudentDataTable dataTable) {
        ...
        public virtual QLSV2DataSet.StudentDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            QLSV2DataSet.StudentDataTable dataTable = new QLSV2DataSet.StudentDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(QLSV2DataSet.StudentDataTable dataTable) {
